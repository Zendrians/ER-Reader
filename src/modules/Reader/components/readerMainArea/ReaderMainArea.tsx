    ...
    <section className="readerMainArea">
      ...
      <div className="readerMainArea__readingPanel">
        <p>
          ...
          bibendum, luctus diam sit amet, imperdiet metus. Fusce commodo, massa
          eu faucibus efficitur, neque tellus tristique mauris, finibus
          consequat enim erat quis sem.
        </p>
        <p>
          Praesent hendrerit convallis dictum. Phasellus nunc est, tristique id
          pulvinar vitae, dictum nec nulla. Mauris accumsan sapien at justo
          semper faucibus. Donec cursus venenatis augue sit amet malesuada.
          Aenean hendrerit aliquam est. Duis laoreet eget ipsum vel dictum. Sed
          lorem tortor, tincidunt non tellus non, volutpat tempor elit.
